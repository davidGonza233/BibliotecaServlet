...
<body>
    ...
    <form id="formulario" action="/BibliotecaServlet/WebDeleteServlet" method="GET">
...
<c:if test="${eliminado}">
            <div class="mensaje">¡Libro eliminado correctamente!</div>
     </c:if>
     <c:if test="${devuelto}">
            ...
            <c:forEach var="book" items="${listCompleta}">
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/BibliotecaServlet/WebDeleteServlet" method="GET" style=" align-items:center; ">
